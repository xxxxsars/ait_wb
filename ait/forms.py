...
class UploadAITForm(forms.Form):
    version = forms.CharField(max_length=255,widget=forms.TextInput(attrs={'class': 'form-control'}),
                              error_messages={'required': 'Version is empyt!', "invalid": "Please insert valid Version"})
    release_note =forms.CharField(widget=forms.Textarea(attrs={'class': 'form-control' ,"rows":"10" }),
                              error_messages={'required': 'Version is empyt!', "invalid": "Please insert valid Version"})
